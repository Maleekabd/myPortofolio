...
const skills = [
    ...
    },
    {
        ...
        description: "A React specializes in developing user interfaces and web applications using the React JavaScript library. They design and implement interactive components, manage state efficiently, and ensure the application's performance and responsiveness.",
        image: reactjs,
    ...
    return (
        <>
            ...
            <section>
                ...
                <div className="-skew-x-2 min-[320px]:grid min-[320px]:grid-cols-1 md:grid md:grid-cols-2 lg:grid lg:grid-cols-3 m-3 p-3 gap-4 rounded-md dark:bg-gray-900 dark:text-gray-100">
                    {skills.map(skill =>
                    (
                        <div className='flex flex-wrap border rounded-md hover:scale-105 hover:-translate-y-6'>
