                    ...
                    <div key={skill.id} className="hover:-translate-y-5 border rounded-md relative h-96">
                        ...
                        <div className="flex flex-col justify-between p-3 space-y-8">
                            ...
                            <Link to={`${skill.Path}`} target="_blank">
                                <button type="button" className="absolute bottom-0 left-0 bg-violet-400 rounded flex items-center justify-center w-full p-2 font-semibold dark:bg-violet-400 dark:text-gray-900 text-sm hover:bg-violet-200 hover:text-opacity-45">Visit</button>
                            </Link>
                        </div>
                    </div>
                ))
